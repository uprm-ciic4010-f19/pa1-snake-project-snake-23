...
public class Player {
    ...
    public void checkCollisionAndMove(){
        ...
        switch (direction){
            case "Left":
                if(xCoord == 0){
                    xCoord = handler.getWorld().GridWidthHeightPixelCount-1;//To teleport to opposite side of screen
                }else{
                    xCoord--;
                }
                break;
		...
		//Checks if snake collides with itself and shows Game over state
    ...
    public void Eat(){
		...
		//Used to refresh player location to eliminate a bug that made a tail/player stay on screen
        for (int i = 0; i < handler.getWorld().GridWidthHeightPixelCount; i++) {
            for (int j = 0; j < handler.getWorld().GridWidthHeightPixelCount; j++) {
    ...
    public void kill(){
        ...
        for (int i = 0; i < handler.getWorld().GridWidthHeightPixelCount; i++) {
         ...
         //Setting GameOver State when killed
    ...
    //Method to add a tail without spawning another apple
    public void addTail() {
        lenght++;
        Tail tail= null;
        switch (direction){
